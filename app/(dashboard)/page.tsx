...
import { Activity, Terminal, ChevronRight, Plus, X } from 'lucide-react';
...
export default function OverviewPage() {
    ...
    return (
        ...
        >
            {/* Left Column: Command Center & Watchlist */}
            ...
            {/* Middle Column: Quant Diagnostic & Macro */}
            <motion.section variants={itemVariants} className="col-span-12 lg:col-span-4 flex flex-col gap-5 min-h-[600px]">
            ...
            {/* Right Column: AI Projection & Flow */}
            <motion.section variants={itemVariants} className="col-span-12 lg:col-span-4 flex flex-col gap-5 min-h-[600px]">
